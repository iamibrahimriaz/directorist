...
window.addEventListener('load', function () {
  ...
  builderDragNDropWrapper.querySelectorAll(".directorist_builder__list__item a").forEach(function (link) {
  ...
  builderDragNDropWrapper.querySelectorAll(".directorist_builder__list__item *").forEach(function (child) {
  ...
  // Drag End
  builderDragNDropWrapper.addEventListener("dragend", function () {
    var newBuilderItemsOrder = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(builderDragNDropWrapper.children).map(function (item) {
      return item.dataset.termId;
    });
  ...
  function getDragAfterElement(builderDragNDropWrapper, y) {
    var draggableElements = _babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(builderDragNDropWrapper.querySelectorAll(".directorist_builder__list__item:not(.dragging)"));
